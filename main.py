...
data_filepath = raw_input('Enter file path for data set > ')
param_filepath = raw_input('Enter file path with prediction parameters > ')
...
num_iter = int(raw_input('Enter number of iterations > '))
